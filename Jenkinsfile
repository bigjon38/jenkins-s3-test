pipeline {
    ...
    stages {
        stage('Set AWS Credentials') {
            steps {
                withCredentials([[
                    ...
                    credentialsId: 'jilesjon' // this needs tp ne changed before runtime to match the jenkins credentials
                ]]) {
                    sh '''
        ...
        stage('Checkout Code') {
            steps {
                git branch: 'main', url: 'https://github.com/bigjon38/jenkins-s3-test.git' 
            }
        }
